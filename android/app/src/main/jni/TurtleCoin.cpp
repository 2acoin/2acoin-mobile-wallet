...
extern "C" jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    KEY_OUTPUT = (jclass) env->NewGlobalRef(env->FindClass("com/armsvault/KeyOutput"));
    ...
    RAW_TRANSACTION = (jclass) env->NewGlobalRef(env->FindClass("com/armsvault/RawTransaction"));
    RAW_TRANSACTION_CONST = env->GetMethodID(RAW_TRANSACTION, "<init>", "([Lcom/armsvault/KeyOutput;Ljava/lang/String;Ljava/lang/String;)V");
    RAW_TRANSACTION_KEY_OUTPUTS = env->GetFieldID(RAW_TRANSACTION, "keyOutputs", "[Lcom/armsvault/KeyOutput;");
    ...
    WALLET_BLOCK_INFO = (jclass) env->NewGlobalRef(env->FindClass("com/armsvault/WalletBlockInfo"));
    WALLET_BLOCK_INFO_CONST = env->GetMethodID(WALLET_BLOCK_INFO, "<init>", "(Lcom/armsvault/RawTransaction;[Lcom/armsvault/RawTransaction;)V");
    WALLET_BLOCK_INFO_COINBASE_TRANSACTION = env->GetFieldID(WALLET_BLOCK_INFO, "coinbaseTransaction", "Lcom/armsvault/RawTransaction;");
    WALLET_BLOCK_INFO_TRANSACTIONS = env->GetFieldID(WALLET_BLOCK_INFO, "transactions", "[Lcom/armsvault/RawTransaction;");

    TRANSACTION_INPUT = (jclass) env->NewGlobalRef(env->FindClass("com/armsvault/TransactionInput"));
    ...
    SPEND_KEY = (jclass) env->NewGlobalRef(env->FindClass("com/armsvault/SpendKey"));
    ...
    INPUT_MAP = (jclass) env->NewGlobalRef(env->FindClass("com/armsvault/InputMap"));
    INPUT_MAP_CONST = env->GetMethodID(INPUT_MAP, "<init>", "(Ljava/lang/String;Lcom/armsvault/TransactionInput;)V");
    INPUT_MAP_PUBLIC_SPEND_KEY = env->GetFieldID(INPUT_MAP, "publicSpendKey", "Ljava/lang/String;");
    INPUT_MAP_TRANSACTION_INPUT = env->GetFieldID(INPUT_MAP, "input", "Lcom/armsvault/TransactionInput;");
...
Java_com_armsvault_TurtleCoinModule_processBlockOutputsJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_armsvault_TurtleCoinModule_generateRingSignaturesJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_com_armsvault_TurtleCoinModule_generateKeyDerivationJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_armsvault_TurtleCoinModule_generateKeyImageJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_armsvault_TurtleCoinModule_deriveSecretKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_armsvault_TurtleCoinModule_derivePublicKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
